Here is a comprehensive `README.md` file tailored for your GitHub repository, based directly on the provided user manual. It uses Markdown formatting appropriate for GitHub.
...
3. Follow the on-screen instructions. A video tutorial is available for detailed steps.
...
1. 
**Data Import:** Upload your `.bed`, `.bim`, and `.fam` files.


2. 
**Preparation:** Select your uploaded BED file and run the overview to count variants and samples.


3. **Sex Check:**
* Identifies discordant sex information.
...
1. 
**SNP Missingness:** Set a threshold (range 0-0.4) to remove variants with high missingness.


2. 
**Minor Allele Frequency (MAF):** Filter SNPs based on MAF threshold (range 0-0.1).
